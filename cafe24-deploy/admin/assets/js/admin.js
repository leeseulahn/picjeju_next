// /picjeju_next/admin/assets/js/admin.js
...
(function () {
  ...
  const memberNavItems = [
    { href: "/picjeju_next/admin/member/list", label: "사용자 목록", icon: "ri-user-3-line", match: ["/picjeju_next/admin/member/list", "/picjeju_next/admin/member/add"] },
    { href: "/picjeju_next/admin/member/permission", label: "운영진", icon: "ri-shield-user-line", match: ["/picjeju_next/admin/member/permission"] },
    { href: "/picjeju_next/admin/member/kakao_friend", label: "친구톡", icon: "ri-kakao-talk-fill", match: ["/picjeju_next/admin/member/kakao_friend"] },
    { href: "/picjeju_next/admin/member/alimtalk", label: "알림톡", icon: "ri-message-3-line", match: ["/picjeju_next/admin/member/alimtalk"] },
    { href: "/picjeju_next/admin/member/sms", label: "SMS·알림톡", icon: "ri-chat-settings-line", match: ["/picjeju_next/admin/member/sms"] },
    { href: "/picjeju_next/admin/member/send", label: "발송 로그", icon: "ri-history-line", match: ["/picjeju_next/admin/member/send"] }
  ];
  ...
  function initMemberSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/member")) return;
    document.body.classList.add("admin-section-member");
    document.body.classList.toggle("admin-member-list-view", activePath === "/picjeju_next/admin/member/list" || activePath.startsWith("/picjeju_next/admin/member/list/"));
    document.body.classList.toggle("admin-member-permission-view", activePath === "/picjeju_next/admin/member/permission" || activePath.startsWith("/picjeju_next/admin/member/permission/"));
    document.body.classList.toggle("admin-member-message-view", activePath.startsWith("/picjeju_next/admin/member/kakao_friend") || activePath.startsWith("/picjeju_next/admin/member/alimtalk"));
    document.body.classList.toggle("admin-member-sms-view", activePath.startsWith("/picjeju_next/admin/member/sms"));
    document.body.classList.toggle("admin-member-send-view", activePath.startsWith("/picjeju_next/admin/member/send"));
    document.body.classList.toggle("admin-member-add-view", activePath.startsWith("/picjeju_next/admin/member/add"));
    ...
    const shouldShowAddUser = activePath === "/picjeju_next/admin/member/list" || activePath.startsWith("/picjeju_next/admin/member/list/") || activePath.startsWith("/picjeju_next/admin/member/add");
    ...
    context.innerHTML = `
      <div class="admin-section-context__head">
        ...
        ${shouldShowAddUser ? '<a class="btn btn-primary btn-sm" href="/picjeju_next/admin/member/add"><i class="ri-user-add-line"></i> 사용자 추가</a>' : ""}
      </div>
  ...
  const pointNavItems = [
    { href: "/picjeju_next/admin/point/list", label: "현황/내역", icon: "ri-list-check-3", match: ["/picjeju_next/admin/point", "/picjeju_next/admin/point/list"] },
    { href: "/picjeju_next/admin/point/setting", label: "지급/차감하기", icon: "ri-add-circle-line", match: ["/picjeju_next/admin/point/setting"] },
    { href: "/picjeju_next/admin/point/chart", label: "통계", icon: "ri-bar-chart-line", match: ["/picjeju_next/admin/point/chart"] }
  ];

  function initPointSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/point")) return;
    document.body.classList.add("admin-section-point");
    document.body.classList.toggle("admin-point-list-view", activePath === "/picjeju_next/admin/point" || activePath === "/picjeju_next/admin/point/list" || activePath.startsWith("/picjeju_next/admin/point/list/"));
    document.body.classList.toggle("admin-point-setting-view", activePath.startsWith("/picjeju_next/admin/point/setting"));
    document.body.classList.toggle("admin-point-chart-view", activePath.startsWith("/picjeju_next/admin/point/chart"));
    ...
    context.innerHTML = `
      <div class="admin-section-context__head">
        ...
        <a class="btn btn-primary btn-sm" href="/picjeju_next/admin/point/setting"><i class="ri-add-circle-line"></i> 포인트 지급</a>
      </div>
  ...
  const contentNavItems = [
    { href: "/picjeju_next/admin/content/post", label: "포스트", icon: "ri-article-line", match: ["/picjeju_next/admin/content/post"] },
    { href: "/picjeju_next/admin/content/category", label: "카테고리", icon: "ri-folder-3-line", match: ["/picjeju_next/admin/content/category"] },
    { href: "/picjeju_next/admin/content/board", label: "게시판 관리", icon: "ri-layout-2-line", match: ["/picjeju_next/admin/content/board"] },
    { href: "/picjeju_next/admin/content/write", label: "게시물", icon: "ri-edit-box-line", match: ["/picjeju_next/admin/content/write"] },
    { href: "/picjeju_next/admin/content/comment", label: "댓글", icon: "ri-chat-3-line", match: ["/picjeju_next/admin/content/comment"] },
    { href: "/picjeju_next/admin/content/report", label: "신고·차단", icon: "ri-shield-flash-line", match: ["/picjeju_next/admin/content/report"] }
  ];

  function initContentSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/content")) return;
    document.body.classList.add("admin-section-content");
    document.body.classList.toggle("admin-content-post-view", activePath.startsWith("/picjeju_next/admin/content/post"));
    document.body.classList.toggle("admin-content-category-view", activePath.startsWith("/picjeju_next/admin/content/category"));
    document.body.classList.toggle("admin-content-board-view", activePath.startsWith("/picjeju_next/admin/content/board"));
    document.body.classList.toggle("admin-content-write-view", activePath.startsWith("/picjeju_next/admin/content/write"));
    document.body.classList.toggle("admin-content-comment-view", activePath.startsWith("/picjeju_next/admin/content/comment"));
    document.body.classList.toggle("admin-content-report-view", activePath.startsWith("/picjeju_next/admin/content/report"));
  ...
  const shoppingNavItems = [
    { href: "/picjeju_next/admin/shopping/product", label: "상품", icon: "ri-store-2-line", match: ["/picjeju_next/admin/shopping/product"] },
    { href: "/picjeju_next/admin/shopping/order", label: "주문", icon: "ri-receipt-line", match: ["/picjeju_next/admin/shopping/order"] },
    { href: "/picjeju_next/admin/shopping/cancel", label: "취소", icon: "ri-close-circle-line", match: ["/picjeju_next/admin/shopping/cancel"] },
    { href: "/picjeju_next/admin/shopping/return", label: "반품", icon: "ri-arrow-go-back-line", match: ["/picjeju_next/admin/shopping/return"] },
    { href: "/picjeju_next/admin/shopping/exchange", label: "교환", icon: "ri-loop-left-line", match: ["/picjeju_next/admin/shopping/exchange"] },
    { href: "/picjeju_next/admin/shopping/review", label: "리뷰", icon: "ri-star-line", match: ["/picjeju_next/admin/shopping/review"] },
    { href: "/picjeju_next/admin/shopping/qna", label: "문의", icon: "ri-question-answer-line", match: ["/picjeju_next/admin/shopping/qna"] },
    { href: "/picjeju_next/admin/shopping/points", label: "적립금", icon: "ri-coins-line", match: ["/picjeju_next/admin/shopping/points"] },
    { href: "/picjeju_next/admin/shopping/coupon", label: "쿠폰", icon: "ri-coupon-3-line", match: ["/picjeju_next/admin/shopping/coupon"] },
    { href: "/picjeju_next/admin/shopping/best", label: "베스트/신상품", icon: "ri-medal-line", match: ["/picjeju_next/admin/shopping/best"] },
    { href: "/picjeju_next/admin/shopping/shipping", label: "배송설정", icon: "ri-truck-line", match: ["/picjeju_next/admin/shopping/shipping"] },
    { href: "/picjeju_next/admin/shopping/settings", label: "환경설정", icon: "ri-settings-3-line", match: ["/picjeju_next/admin/shopping/settings"] }
  ];

  function initShoppingSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/shopping")) return;
    document.body.classList.add("admin-section-shopping");
    document.body.classList.toggle("admin-shopping-product-view", activePath.startsWith("/picjeju_next/admin/shopping/product"));
    document.body.classList.toggle("admin-shopping-order-view", activePath.startsWith("/picjeju_next/admin/shopping/order"));
    document.body.classList.toggle("admin-shopping-cancel-view", activePath.startsWith("/picjeju_next/admin/shopping/cancel"));
    document.body.classList.toggle("admin-shopping-return-view", activePath.startsWith("/picjeju_next/admin/shopping/return"));
    document.body.classList.toggle("admin-shopping-exchange-view", activePath.startsWith("/picjeju_next/admin/shopping/exchange"));
    document.body.classList.toggle("admin-shopping-review-view", activePath.startsWith("/picjeju_next/admin/shopping/review"));
    document.body.classList.toggle("admin-shopping-qna-view", activePath.startsWith("/picjeju_next/admin/shopping/qna"));
    document.body.classList.toggle("admin-shopping-points-view", activePath.startsWith("/picjeju_next/admin/shopping/points"));
    document.body.classList.toggle("admin-shopping-coupon-view", activePath.startsWith("/picjeju_next/admin/shopping/coupon"));
    document.body.classList.toggle("admin-shopping-best-view", activePath.startsWith("/picjeju_next/admin/shopping/best"));
    document.body.classList.toggle("admin-shopping-shipping-view", activePath.startsWith("/picjeju_next/admin/shopping/shipping"));
    document.body.classList.toggle("admin-shopping-settings-view", activePath.startsWith("/picjeju_next/admin/shopping/settings"));
  ...
  const eventNavItems = [
    { href: "/picjeju_next/admin/event", label: "목록", icon: "ri-calendar-event-line", match: ["/picjeju_next/admin/event"] },
    { href: "/picjeju_next/admin/event/add", label: "추가", icon: "ri-add-box-line", match: ["/picjeju_next/admin/event/add"] },
    { href: "/picjeju_next/admin/event/review", label: "후기", icon: "ri-star-smile-line", match: ["/picjeju_next/admin/event/review", "/picjeju_next/admin/event/event/review"] },
    { href: "/picjeju_next/admin/event/calendar", label: "일정", icon: "ri-calendar-check-line", match: ["/picjeju_next/admin/event/calendar"] },
    { href: "/picjeju_next/admin/event/config", label: "환경설정", icon: "ri-settings-3-line", match: ["/picjeju_next/admin/event/config"] }
  ];

  function initEventSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/event")) return;
    document.body.classList.add("admin-section-event");
    document.body.classList.toggle("admin-event-list-view", activePath === "/picjeju_next/admin/event");
    document.body.classList.toggle("admin-event-add-view", activePath.startsWith("/picjeju_next/admin/event/add"));
    document.body.classList.toggle("admin-event-review-view", activePath.startsWith("/picjeju_next/admin/event/review") || activePath.startsWith("/picjeju_next/admin/event/event/review"));
    document.body.classList.toggle("admin-event-calendar-view", activePath.startsWith("/picjeju_next/admin/event/calendar"));
    document.body.classList.toggle("admin-event-config-view", activePath.startsWith("/picjeju_next/admin/event/config"));
  ...
  const bannerNavItems = [
    { href: "/picjeju_next/admin/banner", label: "목록", icon: "ri-carousel-view", match: ["/picjeju_next/admin/banner"] },
    { href: "/picjeju_next/admin/banner/add", label: "추가", icon: "ri-add-box-line", match: ["/picjeju_next/admin/banner/add", "/picjeju_next/admin/banner/edit"] }
  ];

  function initBannerSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/banner")) return;
    document.body.classList.add("admin-section-banner");
    document.body.classList.toggle("admin-banner-list-view", activePath === "/picjeju_next/admin/banner");
    document.body.classList.toggle("admin-banner-add-view", activePath.startsWith("/picjeju_next/admin/banner/add"));
    document.body.classList.toggle("admin-banner-edit-view", activePath.startsWith("/picjeju_next/admin/banner/edit"));
  ...
  const statNavItems = [
    { href: "/picjeju_next/admin/stat/summary", label: "홈", icon: "ri-dashboard-3-line", match: ["/picjeju_next/admin/stat/summary"] },
    { href: "/picjeju_next/admin/stat/visitor", label: "방문자", icon: "ri-user-location-line", match: ["/picjeju_next/admin/stat/visitor"] },
    { href: "/picjeju_next/admin/stat/shopping", label: "매출", icon: "ri-line-chart-line", match: ["/picjeju_next/admin/stat/shopping"] },
    { href: "/picjeju_next/admin/stat/analytics", label: "기간별 분석", icon: "ri-bar-chart-grouped-line", match: ["/picjeju_next/admin/stat/analytics"] },
    { href: "/picjeju_next/admin/stat/mileage", label: "적립금", icon: "ri-coins-line", match: ["/picjeju_next/admin/stat/mileage"] },
    { href: "/picjeju_next/admin/stat/feedback", label: "반응", icon: "ri-chat-smile-2-line", match: ["/picjeju_next/admin/stat/feedback"] },
    { href: "/picjeju_next/admin/stat/keyword", label: "검색어", icon: "ri-search-eye-line", match: ["/picjeju_next/admin/stat/keyword"] },
    { href: "/picjeju_next/admin/stat/page", label: "페이지", icon: "ri-file-chart-line", match: ["/picjeju_next/admin/stat/page"] },
    { href: "/picjeju_next/admin/stat/traffic", label: "유입", icon: "ri-route-line", match: ["/picjeju_next/admin/stat/traffic"] },
    { href: "/picjeju_next/admin/stat/site", label: "사이트", icon: "ri-global-line", match: ["/picjeju_next/admin/stat/site"] }
  ];

  function initStatSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/stat")) return;
  ...
  const configNavItems = [
    { href: "/picjeju_next/admin/config/default", label: "일반", icon: "ri-settings-3-line", match: ["/picjeju_next/admin/config/default"] },
    { href: "/picjeju_next/admin/config/pg", label: "전자결제", icon: "ri-bank-card-line", match: ["/picjeju_next/admin/config/pg"] },
    { href: "/picjeju_next/admin/config/membership", label: "회원·등급", icon: "ri-user-settings-line", match: ["/picjeju_next/admin/config/membership"] },
    { href: "/picjeju_next/admin/config/etc", label: "약관", icon: "ri-file-list-3-line", match: ["/picjeju_next/admin/config/etc"] },
    { href: "/picjeju_next/admin/config/popup", label: "팝업·배너", icon: "ri-window-line", match: ["/picjeju_next/admin/config/popup"] },
    { href: "/picjeju_next/admin/config/adult", label: "인증", icon: "ri-verified-badge-line", match: ["/picjeju_next/admin/config/adult"] },
    { href: "/picjeju_next/admin/config/oauth", label: "소셜 로그인", icon: "ri-login-circle-line", match: ["/picjeju_next/admin/config/oauth"] },
    { href: "/picjeju_next/admin/config/security", label: "보안·권한", icon: "ri-shield-keyhole-line", match: ["/picjeju_next/admin/config/security"] }
  ];

  function initConfigSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/config")) return;
  ...
  function initAppstoreSection() {
    const activePath = normalizePath(location.pathname);
    if (!activePath.startsWith("/picjeju_next/admin/appstore")) return;
  ...
  ready(() => {
    ...
    const activePath = normalizePath(location.pathname);
    const sidebarPath = activePath === "/picjeju_next/admin/point" ? "/picjeju_next/admin/point/list" : activePath;
