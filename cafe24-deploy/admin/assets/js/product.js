// /picjeju_next/admin/assets/js/product.js
(function () {
    ...
    // ====== 데모 상품 데이터 ======
    const DEMO_PRODUCTS = [
      {no: 1001, title: '행복한 코딩 책', subtitle: '입문자를 위한 개발 입문서', thumb: '/picjeju_next/admin/assets/img/sample-thumb.svg', price: 15000, status: '판매중', stock: 50, category: '도서', created: '2024-11-10', updated: '2024-11-11'},
      {no: 1002, title: '제주 감귤 선물세트', subtitle: '달콤한 제주 감귤 5kg', thumb: '/picjeju_next/admin/assets/img/sample-thumb.svg', price: 32000, status: '판매중', stock: 120, category: '식품', created: '2024-11-05', updated: '2024-11-06'},
      {no: 1003, title: '친환경 주방세제', subtitle: '리필형 1L', thumb: '/picjeju_next/admin/assets/img/sample-thumb.svg', price: 8900, status: '품절', stock: 0, category: '생활용품', created: '2024-10-30', updated: '2024-11-01'},
      {no: 1004, title: '고양이 간식 3종세트', subtitle: '닭가슴살 / 연어 / 참치맛', thumb: '/picjeju_next/admin/assets/img/sample-thumb.svg', price: 11900, status: '판매중', stock: 70, category: '반려용품/간식', created: '2024-11-01', updated: '2024-11-08'},
      {no: 1005, title: '제주 자연 체험권', subtitle: '숲속 걷기 + 차 한잔', thumb: '/picjeju_next/admin/assets/img/sample-thumb.svg', price: 25000, status: '숨김', stock: '-', category: '체험상품', created: '2024-09-15', updated: '2024-09-20'}
    ];
