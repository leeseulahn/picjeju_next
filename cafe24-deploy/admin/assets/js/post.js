// /picjeju_next/admin/assets/js/post.js — 포스트 관리 (상태 탭 + 카테고리 셀렉트 + 고급검색)
(() => {
    "use strict";
    ...
    const DEMO = (() => {
        ...
        for (let i = 0; i < 37; i++) {
            ...
            arr.push({
                id: id--,
                thumb: `/picjeju_next/admin/assets/img/sample-thumb.svg`,
                title: `포스트 제목 ${i + 1}`,
                category: cat,
                author: (i % 2 ? '에디A' : '운영자'),
                status: st,
...
<td>${o.author}</td>
    ...
    el.btnWriteSave?.addEventListener('click', () => {
        ...
        state.all.unshift({
            id, thumb: `/picjeju_next/admin/assets/img/sample-thumb.svg`,
