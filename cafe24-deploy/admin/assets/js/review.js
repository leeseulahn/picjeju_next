/* /picjeju_next/admin/assets/js/review.js */
(() => {
    ...
    const DEMO = (() => {
        ...
        for (let i = 0; i < 46; i++) {
            const rating = (i % 5) + 1;
            const imgs = Array.from({ length: (i % 3) }, (_, k) => `/picjeju_next/admin/assets/img/sample-thumb.svg`);
            arr.push({
                id: 61000 + i,
                ...
                productImg: `/picjeju_next/admin/assets/img/sample-thumb.svg`,
