/* /picjeju_next/admin/assets/js/popup.js
...
(function () {
      ...
      const demo = [
        {
          ...
          image:'/picjeju_next/admin/assets/img/sample-thumb.svg',
          link:'https://example.com/event',
          start: start1.toISOString(), end: end1.toISOString(),
          enabled:true, closable:true, once:false, memo:'상단고정'
        },
        {
          ...
          enabled:true, closable:true, once:true, memo:'만료 예시'
        },
        {
          ...
          enabled:true, closable:false, once:false, memo:'예약 예시'
        },
        {
          id: uid(), title:'주말 특가 토스트', type:'toast', location:'전페이지', device:'all',
          content:'주말 한정! 전상품 5% 추가할인',
          image:'', link:'', start:'', end:'', enabled:false, closable:true, once:false, memo:'비활성'
        }
      ];
      ...
      tbl.innerHTML = rows.map(it => {
        ...
        return `
          <tr data-id="${it.id}">
            ...
            <td><div class="small text-muted">${(new Date(parseInt(it.id.slice(1),36))).toLocaleDateString?.('ko-KR')||'-'}</div></td>
            <td>
    ...
    function renderPager(pages){
      ...
      let html = '';
      html += make(view.page-1, '«', false, view.page===1);
      ...
      html += make(view.page+1, '»', false, view.page===pages);
    ...
    function onPreview(e){
      ...
      previewStage.innerHTML = `
        <div class="position-relative" style="min-height:420px;">
          <img src="/picjeju_next/admin/assets/img/sample-thumb.svg" class="img-fluid w-100" alt="">
