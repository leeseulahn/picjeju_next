/* /picjeju_next/admin/assets/js/board-add.js
 * 새 게시물 작성 — /picjeju_next/admin/content/board/add.php
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    $('#boardForm')?.addEventListener('submit', (e) => {
      ...
      alert('게시물이 저장되었습니다 ✅');
      setTimeout(() => {
        location.href = (window.ADMIN_BASE_PATH || '/picjeju_next/admin') + '/content/write';
      }, 1500);
    });
