/* /picjeju_next/admin/assets/js/kakao_friend.js
 * 친구톡 보내기 (데모) — /picjeju_next/admin/member/kakao_friend
...
(function(){
  ...
  - 유효기간: {{coupon_expiry}}
  지금 혜택 확인해보세요.`,
          btnText:'바로가기', btnUrl:'https://example.com/join', img:'/picjeju_next/admin/assets/img/sample-thumb.svg'
        },
        {
  ...
  돌아오신 고객님께 추가 쿠폰을 드려요.`,
          btnText:'쿠폰 받기', btnUrl:'https://example.com/coupon', img:'/picjeju_next/admin/assets/img/sample-thumb.svg'
        }
      ];
