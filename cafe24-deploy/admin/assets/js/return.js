/* /picjeju_next/admin/assets/js/return.js
...
const DEMO = (() => {
    ...
    const prods = [
      ['밤호박 2kg','/picjeju_next/admin/assets/img/sample-thumb.svg'],
      ['무농약 감귤 3kg','/picjeju_next/admin/assets/img/sample-thumb.svg'],
      ['천혜향 2kg','/picjeju_next/admin/assets/img/sample-thumb.svg'],
      ['레드비트 1kg','/picjeju_next/admin/assets/img/sample-thumb.svg'],
      ['당근 5kg','/picjeju_next/admin/assets/img/sample-thumb.svg'],
    ];
    // ✅ "ALL" 제외한 상태 목록만 사용
