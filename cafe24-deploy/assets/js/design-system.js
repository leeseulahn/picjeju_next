(function () {
  ...
  const SELECT_ICON_SRC = "/picjeju_next/assets/images/svg/icon_chevron_bottom.svg";
  ...
  function installStaticApiFallback() {
    ...
    window.fetch = (input, init) => {
      ...
      if (url.origin === window.location.origin && url.pathname.startsWith("/picjeju_next/api/")) {
