(function(){
    const asset = window.picjejuAsset || ((path) => `/picjeju_next/assets/${String(path || "").replace(/^\//, "")}`);
 ...
 * - 여러 폼 인스턴스 지원
 * - HTML 훅:
 *   <form data-comment-uploader data-endpoint="/picjeju_next/api/comments">
...
(function (global) {
    ...
    function setup(form) {
      ...
      form.addEventListener('submit', async (ev) => {
        ...
        try {
          const endpoint = form.dataset.endpoint || '/picjeju_next/api/comments';
